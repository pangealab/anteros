...
def get_version():
    main_file = os.path.join(CURDIR, "anteros", "coerce.py")
...
setup(
    ...
    author_email="anthonyangelo@yahoo.com",
    description="",
    long_description=README,
    long_description_content_type="text/markdown",
    url="https://github.com/pangealab/anteros",
    packages=find_packages(exclude=EXCLUDE_FROM_PACKAGES),
    include_package_data=True,
    keywords=[],
    scripts=[],
    entry_points={"console_scripts": ["coerce=anteros.coerce:main"]},
    zip_safe=False,
